...
// Ported verbatim from SmartTube's `common` module
// (com.liskovsoft.smartyoutubetv2.common.exoplayer.LiveDashManifestParser),
// only the package line changed. It carries YouTube-specific handling for
// live DASH manifests that stock ExoPlayer 2.10.6 does not have, and it is
// stateful, so a new instance is required per live source.
